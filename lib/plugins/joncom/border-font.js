...
.defines(function() {
    ...
    ig.BorderFont = ig.Font.extend({
        ...
        staticInstantiate: function(path, settings) {
            // Load in settings, regardless of whether or not we are going to use this object or reference an existing one.
            // Because these settings have an impact on the generation of the path.
