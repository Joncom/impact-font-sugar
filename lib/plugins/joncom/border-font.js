...
.defines(function() {
    ...
    ig.BorderFont = ig.Font.extend({
        ...
        onload: function(event) {
            ...
            // Use new canvas instead of the original.
            this.data = canvas;
            // Rebuild indices.
            for(var i=0; i<this.indices.length; i++) this.indices[i] += (i * this.borderSize * 2);
            //for(var i=0; i<this.widthMap.length; i++) this.widthMap[i] += (i * this.borderSize * 2 * ig.system.scale);

            this.testImage = newFontData; // Show rebuilt font.
        },
