...
MyGame = ig.Game.extend({
	...
	borderFont5: new ig.BorderFont('media/04b03.font.png', { borderColor: '#FFF', fontColor: '#1B8200' }),
	borderFont6: new ig.BorderFont('media/04b03.font.png', { borderColor: '#FFF', fontColor: '#284CA2' }),
	borderFont7: new ig.BorderFont('media/04b03.font.png', { borderColor: '#FFF', fontColor: '#9D1625' }),
...
// up by a factor of 2
ig.main( '#canvas', MyGame, 60, 340, 135, 2 );
